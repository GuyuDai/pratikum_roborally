...
public class MapBuilder {
    ...
    Image imagelaser1 = new Image(laser1.toString());

    URL laser2 = getClass().getResource("Laser/Laser2.png");
    Image imagelaser2 = new Image(laser2.toString());

    URL laser3 = getClass().getResource("Laser/Laser3.png");
    Image imagelaser3 = new Image(laser3.toString());

    URL wallLaser1 = getClass().getResource("Laser/WallLaser1.png");
    Image imagewallLaser1 = new Image(wallLaser1.toString());

    URL wallLaser2 = getClass().getResource("Laser/WallLaser2.png");
    Image imagewallLaser2 = new Image(wallLaser2.toString());
