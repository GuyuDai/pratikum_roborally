...
public class DeathTrap extends Board {
    public DeathTrap() {
        ...
        map[2][11][1] = new Wall(currentGame, Direction.UP);
        map[2][11][0] = empty;
        ...
        map[5][10][1] = new Wall(currentGame,Direction.LEFT);
        map[5][10][0] = empty;
        ...
        map[6][1][0] = empty;
        map[6][1][1] = new Wall(currentGame, Direction.RIGHT);
        ...
        map[7][11][0] = empty;
        map[7][11][1]= new Wall(currentGame,Direction.DOWN);
