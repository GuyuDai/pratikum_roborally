...
public abstract class DeathTrap extends Board {
    public DeathTrap() {
        super("DeathTrap");
        ...
        map[0][1][0] = empty;
        map[0][2][0] = new ConveyBelt(currentGame,1, Direction.LEFT);
        ...
        map[0][8][0] = empty;
        map[0][9][0] = empty;
        map[0][10][0] = new ConveyBelt(currentGame,1, Direction.LEFT);
        map[0][11][0] = empty;
        map[0][12][0] = empty;
        ...
        map[2][4][0] = new EnergySpace(currentGame,2);
        map[2][5][0] = empty;
        ...
        map[3][5][0] = empty;
        map[3][6][0] = empty;
        map[3][7][0] = new Pit(currentGame);
        map[3][8][0] = new Wall(currentGame, Direction.LEFT);
        ...
        map[5][5][0] = new Wall(currentGame, Direction.DOWN);
        ...
        map[6][1][0] = new Wall(currentGame, Direction.RIGHT);
        map[6][2][0] = new Pit(currentGame);
        map[6][3][0] = empty;
        map[6][4][0] = new EnergySpace(currentGame,2);
        map[6][5][0] = empty;
        map[6][6][0] = empty;
        map[6][7][0] = new EnergySpace(currentGame,2);
        map[6][8][0] = empty;
        map[6][9][0] = empty;
        map[6][10][0] = empty;
        map[6][11][0] = empty;
        ...
        map[7][4][0] = empty;
        map[7][5][0] = empty;
        map[7][5][1]= new Pit(currentGame);
        map[7][5][2]= new Laser(currentGame, 1, Direction.DOWN);
        map[7][6][0] = new Pit(currentGame);
        map[7][7][0] = new PushPanel(currentGame, 2,Direction.RIGHT);
        map[7][8][0] = new Pit(currentGame);
        map[7][9][0] = empty;
        map[7][10][0] = empty;
        map[7][11][0]= new Wall(currentGame,Direction.DOWN);
        map[7][12][0] = empty;
        ...
        map[9][7][0] = new ConveyBelt(currentGame,1, Direction.RIGHT);
        map[9][8][0] = new ConveyBelt(currentGame,1, Direction.RIGHT);
        map[9][9][0] = empty;
        map[9][10][0] = new ConveyBelt(currentGame,1, Direction.LEFT);
        map[9][11][0] = empty;
        map[9][12][0] = empty;//GreenIDontKnow
    }
}
