...
public class LostBearings extends Board {
    public LostBearings() {
        ...
        map[1][0][0] = empty;
        map[1][1][0]= empty;//black white gear;
        map[1][2][0] = empty;
        map[1][3][0] = new ConveyBelt(currentGame,1, Direction.LEFT);;
        map[1][4][0] = new RotatingBelt(currentGame,1, Direction.DOWN, Direction.LEFT);//curvedownleft
        map[1][5][0] = empty;
        ...
        map[1][10][0] = empty;
        map[1][11][0] = new RotatingBelt(currentGame,1, Direction.UP, Direction.LEFT);//curveleftup
        ...
        map[8][4][0] = new RotatingBelt(currentGame,1, Direction.DOWN,Direction.RIGHT);//Rightdownturn
        map[8][5][0] = empty;
        map[8][6][0] = empty;
        map[8][7][0] = empty;
        map[8][8][0] = empty;
        map[8][9][0] = empty;
        map[8][10][0] = empty;
        map[8][11][0] = new RotatingBelt(currentGame,1, Direction.RIGHT, Direction.RIGHT);//UpRightturn
